...
correct_annotation_list = [
    Example(text="field {operation}", separator=" ", left_marker="{", right_marker="}", match="operation"),
    Example(text="field {operation@1}", separator=" ", left_marker="{", right_marker="}", match="operation@1"),
    Example(text="field {operation@-1}", separator=" ", left_marker="{", right_marker="}", match="operation@-1"),
    Example(text="f {operation@-100}", separator=" ", left_marker="{", right_marker="}", match="operation@-100"),
    Example(text="f {o@0}", separator=" ", left_marker="{", right_marker="}", match="o@0"),
    Example(text="fie{ld {operation}", separator=" ", left_marker="{", right_marker="}", match="operation"),
    Example(text="fie {ld} {operation}", separator=" ", left_marker="{", right_marker="}", match="operation"),
    Example(text="fie _operation_", separator=" ", left_marker="_", right_marker="_", match="operation"),
    Example(text="fie_operation_", separator="", left_marker="_", right_marker="_", match="operation"),
    Example(text="fie {{operation}}", separator=" ", left_marker="{{", right_marker="}}", match="operation"),
    Example(text="fie__operation", separator="__", left_marker="", right_marker="", match="operation"),
    Example(text="fie __operation__", separator=" ", left_marker="__", right_marker="__", match="operation"),
    Example(text="fie _|operation|_", separator=" ", left_marker="_|", right_marker="|_", match="operation"),
    Example(text="fie [operation]", separator=" ", left_marker="[", right_marker="]", match="operation"),
    Example(text="fie (operation)", separator=" ", left_marker="(", right_marker=")", match="operation"),
    Example(text="fie operation", separator=" ", left_marker="", right_marker="", match="operation"),
    Example(text="fie @operation>", separator=" ", left_marker="@", right_marker=">", match="operation"),
...
non_annotation_list = [
    ...
    Example(text="field{operation@1}", separator=" ", left_marker="{", right_marker="}"),
